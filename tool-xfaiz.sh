...
echo
echo $pur"==================="$cy" ==================="
echo $i""$pu"  AUTHOR  :  MR,F  "$i"                   "
echo $i""$pu"  WhatsApp:  DI BAWAH"$i"                "
echo $i""$pu"  CHANEL YOUTUBE:RICKO EN"$i"    "
echo $i""$pu"  MASTAH IS ILLUSIION"$i"                "
echo $pur"==================="$cy" ==================="
echo
...
sleep 2
echo $ku"Facebook :"$i" MR.F"
echo $ku"YouTube  :"$i" RICKO EN"
echo $ku"WhatsApp :"$i" 085220205961"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { YOUTUBE RICKO EN }"
exit
fi
